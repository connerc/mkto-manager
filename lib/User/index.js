 ...
 * @param {MktoRequest} mktoRequest
 */
module.exports = function ({ mktoRequest }) {
    /**
     * Constants
     */
    ...
    class User {
        ...
        static async find(searchParams = {}) {
            ...
            const response = await mktoRequest
                .request({
                    method: "get",
                    url: url,
                    params: searchParams,
            ...
            return new UserResponse(response, User);
        ...
        static async findInvited(searchParams = {}) {
            /*searchParams = {
                id: String
            }*/
            ...
            let response = await mktoRequest
                .request({
                    method: "get",
         ...
         */
        static async roles(searchParams = {}) {
            ...
            let response = await mktoRequest.request(requestConfig);
        ...
        makeResponse(resp, InitType = undefined) {
            return new UserResponse(resp, InitType);
        }
        ...
        async create() {
            ...
            let createResponse = new UserResponse(response, this);
        ...
        async update() {
            ...
            let response = await this.request(requestConfig);
            let updateResponse = new UserResponse(response, this);
        ...
        /**
         * Delete one or more Role Entries for a User
         */
    ...
    //  Store a local reference to the instantiated MktoRequest (mktoRequest) instance for User+ additional Active Record pattern methods
    User.prototype.mktoRequest = mktoRequest;
