...
const SpawnEmail = (ParentClass = BaseAsset) => {
    class Email extends ParentClass {
        ...
        async update() {
            let requestConfig = {
                ...
                params: {
                    ...
                    operational: this.get('operational'),
                    published: this.get('published'),
                    textOnly: this.get('textOnly'),
                    webView: this.get('webView'),

                    //  Override Required Props with any that were updated
                    ...this.changedData
                }
            }

            console.log('email update requestConfig', requestConfig)
        ...
        async getContent(params) {
            ...
            let contentResponse =  await this.REQ.mktoRequest(requestConfig)
            return new MktoResponse(contentResponse)
        }
