...
const Spawn = (BaseAsset) => {
    class Folder extends BaseAsset {
        static get endpoint() {
            return "folder";
        }
        ...
        static stream(searchParams) {
            return super.stream(Folder, searchParams)
        }
        ...
        async create() {
            ...
            let createResponse = await this.REQ.request(requestConfig);
        ...
        //     }
        //     let updateResponse = await this.REQ.request(requestConfig)
        ...
        async createToken(data, type = "create") {
            ...
            const createTokenResponse = this.makeResponse(await this.REQ.request(requestConfig));
            if (type === "create") {
