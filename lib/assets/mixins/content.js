...
module.exports = {
    ...
    async getContent(searchParams) {
        ...
        const contentResponse = this.makeResponse(await this.request(requestConfig));
        this.emit("get-content", contentResponse, this);
    ...
    async updateContent(contentId, bodyContent) {
        ...
        this.emit("update-content", updateResponse, this);
